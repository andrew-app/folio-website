...
### <span id="pure-js-approach" class="group flex gap-2 "> **Pure Javascript Approach**  <a href="#pure-js-approach"> <LinkIcon class="hidden group-hover:block hover:fill-yellow-200"/> </a> </span>
...
### <span id="pure-rust-approach" class="group flex gap-2 "> **Pure Rust Approach**  <a href="#pure-rust-approach"> <LinkIcon class="hidden group-hover:block hover:fill-yellow-200"/> </a> </span>
