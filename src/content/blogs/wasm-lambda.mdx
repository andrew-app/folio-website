...
Well we're going throw that belief out the window today as we explore optimising serverless edge functions with web assembly.
...
<details>
<summary>
    <strong>The Rust WASM Module</strong>
</summary>
```rust
#[derive(Debug)]
pub enum Status {
